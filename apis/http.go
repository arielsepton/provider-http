...
import (
	...
	disposiblerequestv1alpha1 "github.com/crossplane-contrib/provider-http/apis/disposiblerequest/v1alpha1"
...
func init() {
	...
	AddToSchemes = append(AddToSchemes,
		...
		disposiblerequestv1alpha1.SchemeBuilder.AddToScheme,
